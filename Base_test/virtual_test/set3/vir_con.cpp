 ...
 * @FilePath     : /My_Cpp_test/virtual/set3/vir_con.cpp
 * @Description  :  构造函数不可以声明为虚函数。同时除了inline之外，构造函数不允许使用其它任何关键字。
 *
 * 为什么构造函数不可以为虚函数？
 *
...
public:
    ...
    // The "Vitrual constructor"
    static Base *Create(int id);

    // The "Vitrual Copy Constructor"
...
public:
    ...
    void ChangeAttributes() { cout << "Derived1 Attribute changed" << endl; }
...
public:
    ...
    void ChangeAttributes() { cout << "Derived2 Attribute changed" << endl; }
...
public:
    ...
    void ChangeAttributes() { cout << "Derived3 Attribute changed" << endl; }
