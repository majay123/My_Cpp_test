 ...
 * @LastEditors  : MCD
 * @LastEditTime : 2022-03-25 12:36:37
 * @FilePath     : /My_Cpp_test/Practice/模板与STL/函数模板/实例练习.cpp
 * @Description  : 
...
int main(int argc, char const *argv[])
{
    ...
    // cout << "2，'a'    的最小值是：" << Min(2, 'a') << endl;  //报错,不同类型无法处理，可以 改成如下
    cout << "2，'a'    的最小值是：" << Min<int>(2, 'a') << endl;  //正确的
    return 0;
}